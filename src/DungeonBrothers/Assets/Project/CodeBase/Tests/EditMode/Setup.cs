...
namespace Project.CodeBase.Tests.EditMode
{
    public class Setup
    {
        ...
        public static IMoverService MoverService(ICharacter character, int mapRows, int mapColumns)
        {
            ...
            IMoverService moverService = Create.MoverService(pathFinder, turnQueue, mapService);
            moverService.Enable();
        ...
        public static IAttackService AttackService(ICharacter[] characters, int range)
        {
            ...
            {
                if (mapService.TryGetTile(character.Logic.Movement.Coordinates, out Tile tile)) 
            ...
            IAttackService attackService = new AttackService(turnQueue, pathFinder,
        ...
        public static ICharacter CharacterForAttack(int damage, int healthPoints, int initiative, CharacterAttackType characterAttackType, CharacterTeam characterTeam)
        {
            ...
            Health health = Create.Health(healthPoints);
        ...
        public static ICharacter CharacterForMovement(int movePoints, bool isMoveThroughObstacles, int level, int initiative)
        {
            ...
            IMovement movement = Create.Movement(character, movePoints, isMoveThroughObstacles);

            character.Logic.Movement.Returns(movement);
            return character;
        }
